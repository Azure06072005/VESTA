...
**Total Ingested Articles**: **757,019 articles** (661,558 in `core.news` + 95,461 in `core.macro_policy`)  
...
### B. Macroeconomic, Regulatory & Sectoral News (`core.macro_policy` — 95,461 Articles across 49 Sources)
...
| 6 | `moj` | Bộ Tư pháp | **46** | 2026-09-07 to 2026-09-07 | **100.0%** | **Probe Batch**. Legal appraisal gazettes. |
...
| :-: | :--- | :--- | :-: | :---: | :-: | :--- |
| 6 | `baodautu` | Báo Đầu tư (MPI) | **15,804** | 2026-09-05 to 2026-09-05 | **100.0%** | **Large Volume**. Needs date backfill (dates stamped on ingestion). |
| 7 | `vietstock` | Vietstock Portal | **15,893** | 2025 to 2026 | **100.0%** | **ACTIVE**. Ingested from 14 HAR archives (insider trades, macro data, disclosures). |
| 8 | `thoibaonganhang` | Thời báo Ngân hàng | **11,748** | 2026-09-05 to 2026-09-05 | **100.0%** | **High Volume**. Banking & monetary credit articles. |
| 9 | `vneconomy` | VnEconomy | **2,248** | 2021 to 2026 | **100.0%** | **ACTIVE**. 14 HAR files ingested (stocks, property, digital economy, market). |
| 10 | `vietnamfinance` | VietnamFinance | **1,155** | 2026 | **100.0%** | **ACTIVE**. 13 HAR archives ingested (banking, corporate debt, investment). |
| 11 | `tinnhanhchungkhoan` | Tin Nhanh Chứng Khoán | **270** | 2026-08-31 to 2026-09-07 | **100.0%** | **Recent Batch**. Needs deep historical pagination. |
| 12 | `thoibaotaichinh` | Thời báo Tài chính VN | **78** | 2026-09-07 to 2026-09-07 | **100.0%** | **Sample Batch**. Fiscal & public debt policy. |
| 13 | `vnanet` | TTXVN (VNA) | **17** | 2026-09-07 to 2026-09-07 | **100.0%** | **Sample Batch**. Official state economic wires. |
| 14 | `tcct` | Tạp chí Công Thương | **10** | 2026-09-07 to 2026-09-07 | **100.0%** | **Sample Batch**. Crawl-delay: 10s enforced. |
| 15 | `nguoiquansat` | Người Quan Sát | **10** | 2026-09-07 to 2026-09-07 | **100.0%** | **Sample Batch**. Ticker surveillance news. |
...
| :-: | :--- | :--- | :-: | :---: | :-: | :--- |
| 16 | `tienphong` | Báo Tiền Phong | **15,197** | 2025 to 2026 | **100.0%** | **MAX PAGES COMPLETED**. High-throughput JSON REST crawler (`deep_portal_crawler.py`) reached backend cap (Page 250) across Zone 3 (Kinh tế), Zone 166 (Địa ốc), Zone 5 (Thế giới). |
| 17 | `tuoitre` | Báo Tuổi Trẻ | **2,461+** *(Active Backfill)* | 2009 to 2026 | **100.0%** | **ACTIVE HISTORICAL BACKFILL** (`task-11091`). Automated runner traversing Zone 11 (Kinh doanh) from Page 31 to Page 4,000 (~80,000 articles back to May 2009) with ISO-8601 `<meta article:published_time>` UTC extraction. |
| 18 | `nhandan` | Báo Nhân Dân | **10** | 2026-09-07 | **100.0%** | **Sample only**. `/kinh-te/` section needs full pagination. |
